...
type Security interface {
	...
	ExchangeUserToken(userid string, remoteInfo model.RemoteInfo) (token security.JwtToken, err error)
	GetUserToken(username string, password string, remoteInfo model.RemoteInfo) (token security.JwtToken, err error)
	GetCachedUserToken(username string, remoteInfo model.RemoteInfo) (token security.JwtToken, err error)
